...
// import { mapCallLogs } from "../../../Services/resources";
...
const ImportCallLogsModal: FunctionComponent<props> = ({
  open,
  close,
  organization_id,
  usersList,
    ...
    >
      ...
      {data.length !== 0 ? (
        <>
          ...
          <p className={styles.contactForm}>Import Data for "Call Logs Form"</p>
...
export default ImportCallLogsModal;
function mapCallLogs(val: any[], map: { [key: string]: string; }, organization_id: string, dispatcher: Dispatch<any>, close: () => void, usersList: any[], arg6: (data: boolean) => void) {
